    ...
    <div class="container">
        <div class="row">
            <div class="col-md-10 col-md-offset-1">
                <form enctype="multipart/form-data" action="/match/{{$match->id}}/update" method="POST">
                    <h1>Update Match</h1>
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="date" id="date" value="{{$match->date}}" class="form-control input-md col-md-4">
                    </div>
                    <div class="form-group">
                        <label class="col-md-4 control-label" for="team1">Team 1</label>
                        <input type="text" name="team1" id="team1" value="{{$match->team1}}" class="form-control input-md col-md-4">
                    </div>
                    <div class="form-group">
                        <label class="col-md-4 control-label" for="team2">Team 2</label>
                        <input type="text" name="team2" id="team2" value="{{$match->team2}}" class="form-control input-md col-md-4">
                    </div>
                    <div class="form-group">
